      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '14px' }}>
        ...
        <div style={{ border: '2px solid #6a3eaf', borderRadius: '8px', overflow: 'hidden' }}>
          ...
          <div style={{ padding: '8px 12px' }}>
            ...
            {(entry?.union_contribution ?? 0) > 0 && <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '10px', color: '#dc2626', marginBottom: '3px' }}><span>Contribuição Assistencial</span><span style={{ fontFamily: 'monospace' }}>- {formatCurrency(entry.union_contribution)}</span></div>}
